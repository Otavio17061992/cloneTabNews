...
export default function AdminDashboard() {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      const resPosts = await fetch("/api/v1/posts?status=pending", {
        headers: authHeaders,
      });
      ...
      const resComments = await fetch("/api/v1/comments?status=pending", {
        headers: authHeaders,
      });
    ...
    <div style={{ paddingTop: "6rem", minHeight: "80vh" }}>
      <div className={styles.dashboardContainer}>
        ...
        <p className="text-muted">
          Revise o conteúdo enviado pela comunidade antes de ir ao ar.
        </p>
