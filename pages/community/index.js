  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setSuccessMsg(
          "Publicação enviada com sucesso! Aguardando aprovação do administrador.",
        );
        setNewPost({
          title: "",
          content: "",
        ...
        alert(
          errorData.error ||
            "Erro ao publicar post. Verifique sua conexão ou tente novamente mais tarde.",
        );
      }
    } catch (err) {
      console.error(err);
      ...
      <div className={styles.pageHeader}>
        ...
        <div className="container">
          <span className="section-label">
            <Layers size={12} /> Comunidade
          </span>
          <h1 className="section-title" style={{ marginTop: "0.5rem" }}>
            Hub de Devs & Recrutadores
          </h1>
