    ...
    <footer className={styles.footer}>
      <div className="container">
          ...
          <div className={styles.columns}>
            ...
            <div className={styles.column}>
              ...
              <ul>
                <li>
                  <Link
                    href="/community?category=Frontend"
                ...
                <li>
                  <Link
                    href="/community?category=Backend"
                    className={styles.footerLink}
                  >
                    Backend
                  </Link>
                ...
                <li>
                  <Link
                    href="/community?category=DevOps"
                    className={styles.footerLink}
                  >
                    DevOps
                  </Link>
                ...
                <li>
                  <Link
                    href="/community?category=Carreira"
                    className={styles.footerLink}
                  >
                    Carreira
                  </Link>
        ...
        <div className={styles.bottom}>
          <p>
            © {new Date().getFullYear()} João Mesquita. Feito por mim com
            Next.js + PostgreSQL
          </p>
        </div>
      </div>
